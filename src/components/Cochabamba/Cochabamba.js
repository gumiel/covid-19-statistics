          ...
          <Card>
            <Card.Body>
              ...
              <p>
                ...
                <Moment format="DD/MM/YYYY">{cochaUltimaFecha.fecha}</Moment>
              </p>
              <p>
                Casos Activos: <b>{cochaUltimaFecha.activos}</b>
              </p>
              <p>
                Casos confirmados: <b>{cochaUltimaFecha.confirmados}</b>
              </p>
              <p>
                Decesos: <b>{cochaUltimaFecha.decesos}</b>
              </p>
              <p>
                Descartados: <b>{cochaUltimaFecha.descartados}</b>
              </p>
              <p>
                Recuperados: <b>{cochaUltimaFecha.recuperados}</b>
              </p>
              <p>
                Sospechosos: <b>{cochaUltimaFecha.sospechosos}</b>
              </p>
            </Card.Body>
          </Card>
        </Col>
      ...
      <Row>
        <Col col="md-12">
          <Card>
            <Card.Body>
              <h5>
                Linea de tiempo en Cochabamba (Cuadro incremental por día)
              </h5>
              <div>
